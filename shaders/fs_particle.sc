...
SAMPLER2DARRAY(s_texColorArray, 1);
uniform vec4 u_particleParams; // x = blend mode, y = useArray(0/1), z/w reserved
...
void main()
{
    ...
    {
        tex = texture2DArray(s_texColorArray, vec3(v_texcoord0.xy, v_texcoord0.w));
    }
