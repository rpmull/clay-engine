...
enum ImGuiStyleVar_
{
    ...
    ImGuiStyleVar_TreeNodeRowHeight,        // float     TreeNodeRowHeight
...
struct ImGuiStyle
{
    ...
    float       TreeNodeRowHeight;          // Preferred row height for TreeNode/CollapsingHeader widgets. Set to 0.0f to use auto height.
